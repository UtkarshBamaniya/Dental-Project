...
const menuItems = [
    ...
    },
    {
        ...
        action: (data) => {
            ...
            deleteDialogRef.value?.openDelete(data.id, 'medical-details.destroy');
        },
    },
];
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <CommonDataTable
                ref="tableRef"
                route_name="medical-details.index"
                :allColumns="allColumns"
                :menuItems="menuItems"
                :permissions="props.permissions"
                moduleNm="medical_details"
            />
        </div>

        <DeleteDialog ref="deleteDialogRef" module-name="medical detail" @fetch-data="tableRef?.fetchData()" />
